...
**Fecha de generación:** 06/12/2025 19:46:24  
...
**Caso Promedio:**
```
7*k/n - 7*n*q/2 + 7*n + 15*q/2 + 20 + 115/n
```
...
**Ecuación:** `7*k/n - 7*n*q/2 + 7*n + 15*q/2 + 20 + 115/n`
**Método:** AnalizadorDirecto

**Pasos:**
1. 📝 Expresión: 7*k/n - 7*n*q/2 + 7*n + 15*q/2 + 20 + 115/n
2. 
3. 🔹 ANÁLISIS DE EXPRESIÓN DIRECTA
4.    Esta NO es una recurrencia, es una fórmula cerrada
5. 
6. 🔹 PASO 1: Analizar expresión
7.    Expresión: 7*k/n - 7*n*q/2 + 7*n + 15*q/2 + 20 + 115/n
8. 
9. 🔹 PASO 2: Identificar términos
10.    • Lineal: n
11.    • Lineal: 7*n
...
**Pasos:**
1. 📝 Expresión: K3 + (n+1)*C
2. 
3. 🔹 ANÁLISIS DE EXPRESIÓN DIRECTA
4.    Esta NO es una recurrencia, es una fórmula cerrada
5. 
6. 🔹 PASO 1: Analizar expresión
7.    Expresión: K3 + (n+1)*C
8. 
9. 🔹 PASO 2: Identificar términos
10.    • Lineal: n
11.    • Constante: k3
