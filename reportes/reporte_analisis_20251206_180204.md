...
**Fecha de generación:** 06/12/2025 18:02:04  
...
**Peor Caso:**
```
2*q*n+3*q+4*n+3-4*q*n-3*q=4*n+3-2*q*n
```
...
**Ecuación:** `4*k/n + 8 + 43/n`
**Método:** AnalizadorDirecto

**Pasos:**
1. 📝 Expresión: 4*k/n + 8 + 43/n
2. 
3. 🔹 ANÁLISIS DE EXPRESIÓN DIRECTA
4.    Esta NO es una recurrencia, es una fórmula cerrada
5. 
6. 🔹 PASO 1: Analizar expresión
7.    Expresión: 4*k/n + 8 + 43/n
8. 
9. 🔹 PASO 2: Identificar términos
10.    • Lineal: n
11.    • Lineal: n
...
**Ecuación:** `2*q*n+3*q+4*n+3-4*q*n-3*q=4*n+3-2*q*n`
**Método:** AnalizadorDirecto

**Pasos:**
1. 📝 Expresión: 2 * q * n + 3 * q + 4 * n + 3 - 4 * q * n - 3 * q = 4 * n + 3 - 2 * q * n
2. 
3. 🔹 ANÁLISIS DE EXPRESIÓN DIRECTA
4.    Esta NO es una recurrencia, es una fórmula cerrada
5. 
6. 🔹 PASO 1: Analizar expresión
7.    Expresión: 4 * n + 3 - 2 * q * n
8. 
9. 🔹 PASO 2: Identificar términos
10.    • Lineal: 4*n
11.    • Lineal: *n
