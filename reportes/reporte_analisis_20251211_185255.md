...
**Fecha de generación:** 11/12/2025 18:52:55  
...
**Duración total:** 562.45 segundos
...
|---------|-------|
| Llamadas LLM | 2 |
| Tokens entrada | 2,926 |
| Tokens salida | 680 |
| **Total tokens** | **3,606** |
| **Costo total** | **$0.018978 USD** |

#### Detalle por Modelo

| Modelo | Llamadas | Tokens | Costo USD |
|--------|----------|--------|-----------|
| claude-sonnet-4-5-20250929 | 2 | 3,606 | $0.018978 |
