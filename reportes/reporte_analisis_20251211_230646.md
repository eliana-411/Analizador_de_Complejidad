...
**Fecha de generación:** 11/12/2025 23:06:46  
...
**Caso Promedio:**
```
(n*(n + 1)*(2*c1 + 2*c2 + 2*c3 + 2*c4 + c5*(n + 3) + c6*(n + 1) + c8*(n + 1) + 2*c9)/2 + n*(6*c1 + 6*c2 + 6*c3 + 6*c4 + c5*(k + 1) + 3*c5*(n + 1) + 5*c5 + c6*k + 3*c6*n + 3*c6 + c7*n + 4*c7 + c8*k + 3*c8*n + 3*c8 + 6*c9) + (n + 1)*(c1 + c2 + c3 + c4 + 2*c5 + c6 + c7 + c8 + c9))/(n*(n + 1))
```
...
**Ecuación:** `(n*(n + 1)*(2*c1 + 2*c2 + 2*c3 + 2*c4 + c5*(n + 3) + c6*(n + 1) + c8*(n + 1) + 2*c9)/2 + n*(6*c1 + 6*c2 + 6*c3 + 6*c4 + c5*(k + 1) + 3*c5*(n + 1) + 5*c5 + c6*k + 3*c6*n + 3*c6 + c7*n + 4*c7 + c8*k + 3*c8*n + 3*c8 + 6*c9) + (n + 1)*(c1 + c2 + c3 + c4 + 2*c5 + c6 + c7 + c8 + c9))/(n*(n + 1))`
**Método:** AnalizadorDirecto

**Pasos:**
1. 📝 Expresión: (n*(n + 1)*(2*c1 + 2*c2 + 2*c3 + 2*c4 + c5*(n + 3) + c6*(n + 1) + c8*(n + 1) + 2*c9)/2 + n*(6*c1 + 6*c2 + 6*c3 + 6*c4 + c5*(k + 1) + 3*c5*(n + 1) + 5*c5 + c6*k + 3*c6*n + 3*c6 + c7*n + 4*c7 + c8*k + 3*c8*n + 3*c8 + 6*c9) + (n + 1)*(c1 + c2 + c3 + c4 + 2*c5 + c6 + c7 + c8 + c9))/(n*(n + 1))
2. 
3. 🔹 ANÁLISIS DE EXPRESIÓN DIRECTA
4.    Esta NO es una recurrencia, es una fórmula cerrada
5. 
6. 🔹 PASO 1: Analizar expresión
7.    Expresión: (n*(n + 1)*(2*c1 + 2*c2 + 2*c3 + 2*c4 + c5*(n + 3) + c6*(n + 1) + c8*(n + 1) + 2*c9)/2 + n*(6*c1 + 6*c2 + 6*c3 + 6*c4 + c5*(k + 1) + 3*c5*(n + 1) + 5*c5 + c6*k + 3*c6*n + 3*c6 + c7*n + 4*c7 + c8*k + 3*c8*n + 3*c8 + 6*c9) + (n + 1)*(c1 + c2 + c3 + c4 + 2*c5 + c6 + c7 + c8 + c9))/(n*(n + 1))
8. 
9. 🔹 PASO 2: Identificar términos
10.    • Lineal: n
11.    • Lineal: n
...
55.    • Constante: c9
56. 
57. 🔹 PASO 3: Determinar término dominante
58.    Jerarquía: constante < log(n) < n < n·log(n) < n² < n³ < 2ⁿ < n!
59.    Término dominante: lineal
60. 
61. ✅ SOLUCIÓN: T(n) = n
...
**Duración total:** 401.10 segundos
