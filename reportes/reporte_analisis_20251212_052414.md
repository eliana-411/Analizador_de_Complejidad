...
**Fecha de generación:** 12/12/2025 05:24:14  
...
### 5.1 Método Utilizado: EcuacionCaracteristica
...
|------|-------------------|---------------------|-------------------|
| Resultado | Θ(2ⁿ) | Θ(2ⁿ) | Θ(2ⁿ) |

**Observación:** ⚠️ Complejidad constante: Θ(2ⁿ) en todos los casos
...
**Duración total:** 253.64 segundos
