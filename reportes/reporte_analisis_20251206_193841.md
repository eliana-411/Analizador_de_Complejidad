...
**Fecha de generación:** 06/12/2025 19:38:41  
...
**Caso Promedio:**
```
(13*2**k*k + 3*2**k - 32*n*q + 26*n*log2(n) + 12*n + 26*posiciones_restantes*log2(n) + 6*posiciones_restantes + 26*log2(n) + 528)/(2*n)
```
...
**Ecuación:** `(13*2**k*k + 3*2**k - 32*n*q + 26*n*log2(n) + 12*n + 26*posiciones_restantes*log2(n) + 6*posiciones_restantes + 26*log2(n) + 528)/(2*n)`
**Método:** AnalizadorDirecto

**Pasos:**
1. 📝 Expresión: (13*2**k*k + 3*2**k - 32*n*q + 26*n*log2(n) + 12*n + 26*posiciones_restantes*log2(n) + 6*posiciones_restantes + 26*log2(n) + 528)/(2*n)
2. 
3. 🔹 ANÁLISIS DE EXPRESIÓN DIRECTA
4.    Esta NO es una recurrencia, es una fórmula cerrada
5. 
6. 🔹 PASO 1: Analizar expresión
7.    Expresión: (13*2**k*k + 3*2**k - 32*n*q + 26*n*log2(n) + 12*n + 26*posiciones_restantes*log2(n) + 6*posiciones_restantes + 26*log2(n) + 528)/(2*n)
8. 
9. 🔹 PASO 2: Identificar términos
10.    • Lineal-logarítmico: n*log2(n)
11.    • Lineal: 32*n
12.    • Lineal: 26*n
13.    • Lineal: n
14.    • Lineal: 12*n
...
25.    • Constante: c
26. 
27. 🔹 PASO 3: Determinar término dominante
28.    Jerarquía: constante < log(n) < n < n·log(n) < n² < n³ < 2ⁿ < n!
29.    Término dominante: n_log_n
30. 
31. ✅ SOLUCIÓN: T(n) = n·log(n)

**Explicación:** Expresión directa con complejidad n·log(n)
...
13.    • Constante: c
14. 
15. 🔹 PASO 3: Determinar término dominante
16.    Jerarquía: constante < log(n) < n < n·log(n) < n² < n³ < 2ⁿ < n!
17.    Término dominante: lineal
18. 
19. ✅ SOLUCIÓN: T(n) = n
...
**Duración total:** 118.72 segundos
