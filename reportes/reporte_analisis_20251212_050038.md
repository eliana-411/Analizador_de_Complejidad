...
**Fecha de generación:** 12/12/2025 05:00:37  
...
**Duración total:** 840.83 segundos
...
|---------|-------|
| Llamadas LLM | 3 |
| Tokens entrada | 4,389 |
| Tokens salida | 1,088 |
| **Total tokens** | **5,477** |
| **Costo total** | **$0.029487 USD** |

#### Detalle por Modelo

| Modelo | Llamadas | Tokens | Costo USD |
|--------|----------|--------|-----------|
| claude-sonnet-4-5-20250929 | 3 | 5,477 | $0.029487 |
